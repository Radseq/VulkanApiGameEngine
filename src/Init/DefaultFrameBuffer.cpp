...
void DefaultFrameBuffer::ImageViewForSwapChainImg ()
{
	...
	colorSwapChainImageView.components = {
...
const std::vector<vk::Framebuffer>& DefaultFrameBuffer::getFrameBuffers ()
{
...
void DefaultFrameBuffer::createRenderPass ()
{
	...
	dependency2.srcAccessMask = vk::AccessFlagBits::eColorAttachmentRead | vk::AccessFlagBits::eColorAttachmentWrite; // 0
...
const vk::RenderPass& DefaultFrameBuffer::getVkRenderPass ()
{
...
void DefaultFrameBuffer::createColorResources ()
{
	...
	imageInfo.mipLevels = colorImage.mipLevels;
...
void DefaultFrameBuffer::createDepthResources ()
{
	...
	imageInfo.extent.height = swapChainExtent.height;
	imageInfo.extent.depth = 1;
	imageInfo.mipLevels = depthImage.mipLevels;
	imageInfo.arrayLayers = 1;
