...
namespace GraphicCore {
    ...
    void DeviceCreateInfo::update( ) {
        ...
        for (auto i = 0; i < size; ++i) {
            ...
            deviceQueue.queueCount       = GraphicCore::util::to_uint_32_t (deviceQueuePriorities.size( ));
            deviceQueue.pQueuePriorities = deviceQueuePriorities.data( );
        }

        this->queueCreateInfoCount = GraphicCore::util::to_uint_32_t (deviceQueues.size( ));
