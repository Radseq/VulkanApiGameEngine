...
namespace GameCore {
    ...
    void CoreBufferManager::stageToDeviceBuffer (GameCore::CoreBuffer& result, const vk::BufferUsageFlags& usage,
    ...
    void CoreBufferManager::createBuffer (GameCore::CoreBuffer& result, const vk::BufferUsageFlags& usageFlags,
    ...
    void CoreBufferManager::createStagingBuffer (GameCore::CoreBuffer& result, const vk::DeviceSize& size,
        ...
        if (data != nullptr) { 
            ...
            // ok i coped code from device.copyToMemory to GameCore::CoreBuffer (result)
    ...
    void CoreBufferManager::createDeviceBuffer (GameCore::CoreBuffer& result, const vk::BufferUsageFlags& usageFlags,
                                                const vk::DeviceSize& size) const {
        createBuffer (result, usageFlags, vk::MemoryPropertyFlagBits::eDeviceLocal, size);
    }

    void CoreBufferManager::createSizedUniformBuffer (GameCore::CoreBuffer& result, const vk::DeviceSize& size) const {
