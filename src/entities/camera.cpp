...
float Camera::calculateHorizontalDistance( ) { return distanceFromPlayer * std::cos (Math::toRadians (pitch)); }
float Camera::calculateVerticalDistance( ) { return distanceFromPlayer * std::sin (Math::toRadians (pitch)); }
