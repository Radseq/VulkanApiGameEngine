...
void SkySphere::loadAssets( )
{
    ...
    samplerInfo.maxLod                            = static_cast<float> (skySphereTexture->GetMipLevels( ));
    ...
    skySphereTextureImageSampler.Create (samplerInfo);
}
...
void SkySphere::setupDescriptorSets (GraphicCore::DescriptorPool& descPool)
{
    ...
    skySphereTextureDescImageInfo.imageLayout = vk::ImageLayout::eShaderReadOnlyOptimal;
    ...
    std::vector<vk::WriteDescriptorSet> writeDescriptorSets {
        ...
        {skySphereDescriptorSet, 1, 0, 1, vk::DescriptorType::eCombinedImageSampler, &skySphereTextureDescImageInfo},
    };
