...
Entity::Entity (VulkanGame::Ref<TexturedModel> Model, glm::vec3 const& Position, glm::vec3 const& Rotation,
...
void Entity::setModel (VulkanGame::Ref<TexturedModel> Model) { model = Model; }
...
VulkanGame::Ref<TexturedModel> Entity::getTexturedModel( ) const { return model; }
